...
if(@$_SESSION['id_user'] )
{
	...
	<div id="tabels">
		...
		<table id="enemy"  onmousedown="setMouseIsDown(true)" onmouseup="setMouseIsDown(false)">
			<tr>
				<td><button type="button" class="button" col="0" row="0" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="0" row="1" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="0" row="2" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="0" row="3" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="0" row="4" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="0" row="5" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="0" row="6" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="0" row="7" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="0" row="8" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="0" row="9" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
			</tr><tr>
				<td><button type="button" class="button" col="1" row="0" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="1" row="1" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="1" row="2" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="1" row="3" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="1" row="4" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="1" row="5" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="1" row="6" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="1" row="7" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="1" row="8" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="1" row="9" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
			</tr><tr>
				<td><button type="button" class="button" col="2" row="0" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="2" row="1" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="2" row="2" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="2" row="3" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="2" row="4" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="2" row="5" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="2" row="6" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="2" row="7" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="2" row="8" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="2" row="9" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
			</tr><tr>
				<td><button type="button" class="button" col="3" row="0" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="3" row="1" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="3" row="2" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="3" row="3" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="3" row="4" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="3" row="5" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="3" row="6" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="3" row="7" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="3" row="8" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="3" row="9" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
			</tr><tr>
				<td><button type="button" class="button" col="4" row="0" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="4" row="1" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="4" row="2" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="4" row="3" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="4" row="4" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="4" row="5" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="4" row="6" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="4" row="7" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="4" row="8" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="4" row="9" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
			</tr><tr>
				<td><button type="button" class="button" col="5" row="0" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="5" row="1" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="5" row="2" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="5" row="3" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="5" row="4" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="5" row="5" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="5" row="6" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="5" row="7" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="5" row="8" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="5" row="9" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
			</tr><tr>
				<td><button type="button" class="button" col="6" row="0" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="6" row="1" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="6" row="2" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="6" row="3" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="6" row="4" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="6" row="5" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="6" row="6" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="6" row="7" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="6" row="8" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="6" row="9" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
			</tr><tr>
				<td><button type="button" class="button" col="7" row="0" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="7" row="1" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="7" row="2" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="7" row="3" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="7" row="4" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="7" row="5" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="7" row="6" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="7" row="7" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="7" row="8" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="7" row="9" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
			</tr><tr>
				<td><button type="button" class="button" col="8" row="0" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="8" row="1" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="8" row="2" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="8" row="3" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="8" row="4" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="8" row="5" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="8" row="6" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="8" row="7" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="8" row="8" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="8" row="9" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
			</tr><tr>
				<td><button type="button" class="button" col="9" row="0" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="9" row="1" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="9" row="2" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="9" row="3" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="9" row="4" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="9" row="5" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="9" row="6" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="9" row="7" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="9" row="8" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
				<td><button type="button" class="button" col="9" row="9" owner="enemy" onclick="change(this)" onmouseover="changeIfOver(this)" style="width: 20px; height: 20px;"></button></td>
			</tr>
